...
const AddSalon = () => {
  ...
  const [formData, setFormData] = useState({
    name: "", ownerName: "", email: "", phone: "", location: "", about: "",
  });
    ...
    <div>
      ...
      <Card className="max-w-[650px] mx-auto" accent>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Input label="Owner Name" name="ownerName" placeholder="Enter owner name" required value={formData.ownerName} onChange={handleChange} />
