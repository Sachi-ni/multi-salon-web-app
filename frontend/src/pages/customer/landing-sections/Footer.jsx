      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-white hover:bg-accent hover:text-primary hover:shadow-[0_0_15px_rgba(245,200,0,0.6)] transition-all duration-300 hover:-translate-y-0.5">
              ...
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-white hover:bg-accent hover:text-primary hover:shadow-[0_0_15px_rgba(245,200,0,0.6)] transition-all duration-300 hover:-translate-y-0.5">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-white hover:bg-accent hover:text-primary hover:shadow-[0_0_15px_rgba(245,200,0,0.6)] transition-all duration-300 hover:-translate-y-0.5">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-white/60 text-sm"><Mail className="w-5 h-5 text-accent shrink-0 mt-0.5" /><span className="flex flex-col gap-1"><a href="mailto:info@salonhub.com" className="hover:text-accent hover:drop-shadow-[0_0_10px_rgba(245,200,0,0.7)] transition-all duration-300">info@salonhub.com</a><a href="mailto:bookings@salonhub.com" className="hover:text-accent hover:drop-shadow-[0_0_10px_rgba(245,200,0,0.7)] transition-all duration-300">bookings@salonhub.com</a></span></li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-white/40">
            <Link to="/privacy" className="hover:text-accent hover:drop-shadow-[0_0_10px_rgba(245,200,0,0.7)] transition-all duration-300">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-accent hover:drop-shadow-[0_0_10px_rgba(245,200,0,0.7)] transition-all duration-300">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
